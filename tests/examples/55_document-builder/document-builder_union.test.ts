...
test(`document-builder_union`, async () => {
  const exampleResult = await runExample(`./examples/55_document-builder/document-builder_union.ts`)
  ...
  await expect(exampleResultMaybeEncoded).toMatchFileSnapshot(
    `../../../examples/__outputs__/55_document-builder/document-builder_union.output.txt`,
  )
})
