...
test(`document-builder_batch`, async () => {
  const exampleResult = await runExample(`./examples/55_document-builder/document-builder_batch.ts`)
  ...
  await expect(exampleResultMaybeEncoded).toMatchFileSnapshot(
    `../../../examples/__outputs__/55_document-builder/document-builder_batch.output.txt`,
  )
})
