...
test(`document-builder_document`, async () => {
  const exampleResult = await runExample(`./examples/55_document-builder/document-builder_document.ts`)
  ...
  await expect(exampleResultMaybeEncoded).toMatchFileSnapshot(
    `../../../examples/__outputs__/55_document-builder/document-builder_document.output.txt`,
  )
})
