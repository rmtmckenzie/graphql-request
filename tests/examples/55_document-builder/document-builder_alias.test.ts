...
test(`document-builder_alias`, async () => {
  const exampleResult = await runExample(`./examples/55_document-builder/document-builder_alias.ts`)
  ...
  await expect(exampleResultMaybeEncoded).toMatchFileSnapshot(
    `../../../examples/__outputs__/55_document-builder/document-builder_alias.output.txt`,
  )
})
